...
<div class="product-detail-app">
    <form action="{{ route('cart.process') }}" method="post">
        ...
        <input type="hidden" name="product_price_old" value="{{ $product->old_price }}">
        <input type="hidden" name="product_price_new" value="{{ $product->new_price }}">
        <input type="hidden" name="product_quantity" value="1" id="selectedQuantity">
        <input type="hidden" name="product_size" value="S" id="selectedSize">
        <input type="hidden" name="product_color" value="Pink" id="selectedColor">
        <input type="hidden" name="product_image" value="{{ $productImages[0]->path }}">

        <div class="detail-app">
            <div class="slide">
                <div class="slide-list">
                    <div class="row">
                        @for ($index = 0; $index < min(7, count($productImages)); $index++) <div class="column mt-16">

                            <img class="" src="{{ asset($productImages[$index]->path) }}" onclick="currentSlide(`{{ $index + 1 }}`)" alt="">
                    </div>
                    @endfor
                </div>
            </div>
        ...
        <div class="product-detail-content">
            ...
            <div class="product-detail-size">
                ...
                <div class="size">
                    <div class="size-s active-size" onclick="setSize('S')">S</div>
                    <div class="size-l" onclick="setSize('L')">L</div>
                    <div class="size-m" onclick="setSize('M')">M</div>
                </div>
            </div>
            ...
            <div class="product-detail-color">
                ...
                <div class="color">
                    <div class="color-pink icon-color-border" onclick="setColor('Pink')">
                        <img src="{{ asset('images/icon_image/color-pink.png') }}" alt="">
                    </div>
                    <div class="color-black" onclick="setColor('Black')">
                        <img src="{{ asset('images/icon_image/color-black.png') }}" alt="">
                    </div>
                    <div class="color-white" onclick="setColor('White')">
            ...
            <div class="product-detail-button">
                ...
                <a href="">
                    <button type="submit" class="btn-cart" onclick="setSelectedSize('L'); setSelectedQuantity(2);">THÊM VÀO GIỎ HÀNG</button>
        ...
        <div class="evaluate-quantity">
            ...
            <div class="evaluate-quantity-box">
                <ul>
                    ...
                    <li class="li-ml"><img src="{{ asset('images/icon_image/icon-star-blue.svg') }}" alt=""></li>
                    <li class="li-ml"><img src="{{ asset('images/icon_image/icon-star-blue.svg') }}" alt=""></li>
                    <li class="li-ml"><img src="{{ asset('images/icon_image/icon-star-blue.svg') }}" alt=""></li>
                    <li class="li-ml"><img src="{{ asset('images/icon_image/icon-star-blue.svg') }}" alt=""></li>
                </ul>
            ...
            <ul>
                ...
                <li>
                    <ul class="evaluate-box-star-rating">
                        ...
                        <li class="li-ml"><img src="{{ asset('images/icon_image/icon-star-blue.svg') }}" alt=""></li>
                        <li class="li-ml"><img src="{{ asset('images/icon_image/icon-star-blue.svg') }}" alt=""></li>
                        <li class="li-ml"><img src="{{ asset('images/icon_image/icon-star-white.svg') }}" alt=""></li>
                        <li class="li-ml">
                            <div class="rating-separation"></div>
                        </li>
                        <li class="li-ml" style="color: rgba(37,36,37,.5);">0</li>
...
<!-- <script src="{{ asset('client/js/showSlides.js') }}"></script> -->
</div>

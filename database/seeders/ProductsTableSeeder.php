...
class ProductsTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                'id' => 'DD05090',
                'name' => 'Đầm maxi trễ vai',
                'old_price' => 299.000,
                'new_price' => 820.000,
                'thumbnail' => 'images/product/dresses/dam-maxi-tre-vai-01.jpg',
                'categorie_id' => 2,
                'quantity' => 30,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                'id' => 'DD10053',
                'name' => 'Đầm kiểu lệch vai',
                'old_price' => 476.000,
                'new_price' => 595.000,
                'thumbnail' => 'images/product/dresses/dam-kieu-lech-vai-01.jpg',
                'categorie_id' => 2,
                'quantity' => 30,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                'id' => 'DD09016',
                'name' => 'Đầm A bâu cánh sen',
                'old_price' => 275.000,
                'new_price' => 550.000,
                'thumbnail' => 'images/product/dresses/dam-a-bau-canh-sen-01.jpg',
                'categorie_id' => 2,
                'quantity' => 30,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                'id' => 'VD12086',
                'name' => 'Chân váy A lưng kiểu',
                'old_price' => 297.000,
                'new_price' => 330.000,
                'thumbnail' => 'images/product/fashion/chan-vay-chu-a-lung-kieu-01.jpg',
                'categorie_id' => 3,
                'quantity' => 30,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'old_price' => 477.000,
                'new_price' => 530.000,
                'thumbnail' => 'images/product/fashion/chan-vay-xoe-01.jpg',
                'categorie_id' => 3,
                'quantity' => 30,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                'id' => 'ATD12050',
                'name' => 'Áo thun kiểu cổ tim',
                'old_price' => 129.000,
                'new_price' => 250.000,
                'thumbnail' => 'images/product/fashion/ao-thun-kieu-co-tim-01.jpg',
                'categorie_id' => 3,
                'quantity' => 30,
                'created_at' => $now,
                'updated_at' => $now,
